...
public class PesquisarSetarLicenca {
    ...
    public void setarLicenca() {
        ...
        telaLicenca.cboEmissorLicenca.setSelectedItem(telaLicenca.tblCadastroLicenca.getModel().getValueAt(setar, 2).toString());
        ...
        if (telaLicenca.cboAtivo.getSelectedItem().equals("Não")) {
            ...
            telaLicenca.cboEmissorLicenca.setEnabled(false);
        } else {
            telaLicenca.txtIdLicenca.setEnabled(true);
            telaLicenca.txtNomeLicenca.setEnabled(true);
            telaLicenca.cboEmissorLicenca.setEnabled(true);
        }
    }
        ...
        try {
            ...
            while(rs.next()){
               ...
               telaLicenca.cboEmissorLicenca.addItem(rs.getString("nome"));
               telaLicenca.cboEmissorLicenca.updateUI();
            }
        ...
        public int retornarIdEmissor(){
            int posicaoId = telaLicenca.cboEmissorLicenca.getSelectedIndex();
            return posicaoId + 1;
        }
}
